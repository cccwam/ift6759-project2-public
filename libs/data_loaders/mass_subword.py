...
class MassSubwordDataLoaderPretraining:
    ...
    def build(self, batch_size):
        ...
        sentences_both_train = datasets['sentences_all_train'].shuffle(buffer_size=1000000)#.take(50000)
        sentences_both_validation = datasets['sentences_all_validation'].shuffle(buffer_size=1000000)#.take(5000)
